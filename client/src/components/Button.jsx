...
const Button = ({ children, type = 'button', variant = 'primary', onClick }) => {
    const variants = {
        primary: 'bg-white text-black py-2 px-4 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-0 focus:ring-gray-300 hover:bg-gray-100 border border-gray-300/75',
