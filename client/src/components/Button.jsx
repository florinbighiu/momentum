...
const Button = ({ children, type = 'button', variant = 'primary', onClick }) => {
    const variants = {
        primary: 'bg-gradient-to-r from-pink-500 to-violet-600 text-white font-semibold py-2 px-5 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-0 focus:ring-gray-300 hover:bg-gray-100 ',
